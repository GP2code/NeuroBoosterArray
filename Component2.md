## Component 2 content:
### 1. Create plink binaries per CHR
...
### 2. Parse the info file into 6 super-populations and extract from the binary files you just created.
```
...
### 3. Make the per CHR files for each super-population
...
### 6. Run TagIt in paralell on the cluster
